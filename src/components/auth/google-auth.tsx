...
export default function GoogleAuthComponent() {
  ...
  return (
    <Button
      ...
      className='w-full h-12 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 hover:border-gray-400 transition-colors'
      variant='outline'
    >
      <div className='flex items-center justify-center space-x-2'>
        ...
        <span className='text-sm font-medium'>Влезте с Google</span>
      </div>
    </Button>
  );
}
